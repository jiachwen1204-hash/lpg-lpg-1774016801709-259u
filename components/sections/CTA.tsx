...
export default function CTA() {
  return (
    <section className="py-section relative overflow-hidden bg-gradient-to-b from-surface via-surface to-[#f0f4f8]">
      {/* Subtle depth grid */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <AnimateIn>
          ...
          <h2 className="font-heading font-black text-[clamp(2.5rem,5vw,4rem)] leading-[1.1] mb-6">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#0F172A] via-brand-600 to-[#0369A1]">
              {CONTENT.heading}
            </span>
          </h2>
          <p className="text-lg text-content-secondary mb-12 max-w-xl mx-auto leading-relaxed">
            {CONTENT.subtext}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <div className="relative group">
              ...
              <a
                ...
                className="relative px-10 py-4.5 font-body font-semibold text-lg bg-brand-500 text-white rounded-card hover:bg-brand-700 hover:shadow-glow transition-all ease-expo-out active:scale-[0.97]"
              >
                {CONTENT.cta.label}
              </a>
            </div>
            <a
              ...
              className="relative px-10 py-4.5 font-body font-medium text-base border-2 border-surface-border text-content-primary rounded-card hover:border-brand-500 hover:text-brand-600 transition-all ease-expo-out bg-surface/50 backdrop-blur-sm"
            >
        ...
        <AnimateIn delay={100}>
          <div className="mt-16 pt-10 border-t border-surface-border">
            <p className="text-sm text-content-muted mb-5">Trusted by forward-thinking organizations</p>
